...
def parse_args():
    ...
    parser.add_argument("--sizes", nargs="+", type=int, required=True, help="List of sample sizes")
...
def main():
    ...
    try:
        ...
        selections = select_nested_random_files(files=all_files, sizes=args.sizes, seed=args.seed)
