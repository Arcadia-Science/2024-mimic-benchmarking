...
# Compare counts
if total_record_ids == num_pdb_files:
    print("✅ The total number of Record ID entries matches the number of .pdb files.")
else:
    print("⚠️ Mismatch detected!")
    print(f"🔍 Difference: {abs(total_record_ids - num_pdb_files)}")
